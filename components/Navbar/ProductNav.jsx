...
const ProductNav = () => {
  ...
  const handleNextClick = () => {
    if (currentIndex < heroSectionData.length - 1) {
      setCurrentIndex(currentIndex + 1);
    }
  };
  ...
  return (
   <div>
    ...
    <button onClick={handlePrevClick} className='bg-secondary  l-btn font-space text-[13px]  font-[400] drop-shadow-2xl '>
    ...
    <h2>Previous</h2> 
     ...
     <button onClick={handleNextClick}  className='bg-secondary  l-btn font-space text-[13px]  font-[400] drop-shadow-2xl '>
    <div className='flex flex-row items-center gap-[0.2rem]' > 
    <div className='flex flex-row items-center gap-2'>
